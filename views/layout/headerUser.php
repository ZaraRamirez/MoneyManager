...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Inter&family=Jost:wght@300;600&display=swap" rel="stylesheet">
  <!--- Icono navegador --->
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/MoneyManager/views/user/inicio.php">INICIO</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/MoneyManager/views/user/ingresos.php">INGRESOS</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/MoneyManager/views/user/egresos.php">EGRESOS</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/MoneyManager/views/user/calculadora.php">CALCULADORA</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/MoneyManager/views/user/informes.php">INFORMES</a>
            </li>
            <li class="nav-item">
